...
public class Receiver {
	...
	public Receiver(int senderPort, int receiverPort, String message) {
					...
					if (Arrays.equals(received_checksum, calculated_checksum)){
						...
						if (seqNum == nextSeqNum){
							...
							if (in_pkt.getLength() == 12){
								...
								for (int i=0; i<20; i++) receiverSocket.send(new DatagramPacket(ackPkt, ackPkt.length, senderAddress, receiverPort));
							...
							if (seqNum==0 && prevSeqNum==-1){
								...
								//TODO: replace this code with taking a string
								// create file
